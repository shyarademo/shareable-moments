...
const Login = () => {
  ...
  const { login, googleLogin, isLoading, pendingTemplateSlug, setPendingTemplateSlug } = useAuth();
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md">
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center"><span className="px-4 bg-background text-xs text-muted-foreground font-body">or continue with email</span></div>
        </div>
